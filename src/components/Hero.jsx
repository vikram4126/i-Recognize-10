          ...
          <div className="flex flex-col items-center text-center gap-8">
            ...
            >
              <div className="flex flex-col items-center gap-4">
                <span className="text-[10px] font-black tracking-[0.3em] uppercase text-white/40 mb-2">{hero.timerLabel}</span>
                <div className="flex items-center gap-4 md:gap-8 px-8 py-4 bg-black/40 backdrop-blur-2xl border border-white/10 rounded-full shadow-2xl">
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-[10px] font-black text-[#ACEAFF] uppercase tracking-widest">{hero.units.days}</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-[10px] font-black text-[#ACEAFF] uppercase tracking-widest">{hero.units.hrs}</span>
                  </div>
                  <span className="text-xl md:text-2xl font-black text-white/10 -mt-3">:</span>
                  <div className="flex flex-col items-center">
                    <span className="text-2xl md:text-4xl font-black text-white leading-none mb-1">{formatNumber(timeLeft.minutes)}</span>
                    <span className="text-[10px] font-black text-[#ACEAFF] uppercase tracking-widest">{hero.units.min}</span>
                  </div>
                  ...
                  <div className="md:flex hidden flex-col items-center">
                    ...
                    <span className="text-[10px] font-black text-[#ACEAFF]/50 uppercase tracking-widest">{hero.units.sec}</span>
                  </div>
                </div>
              </div>
            </motion.div>
